...
///
/// mod kw {
///     inf_wast::custom_keyword!(inline);
/// }
///
...
/// inf_wast::custom_reserved!(spaceship = "<=>");
///
...
///     lhs: inf_wast::core::Expression<'a>,
///     rhs: inf_wast::core::Expression<'a>,
/// }
///
...
/// # }
/// # mod annotation { inf_wast::annotation!(producer); }
///
