...
//! ```
//! use inf_wast::Wat;
//! use inf_wast::parser::{self, ParseBuffer};
//!
//! # fn foo() -> Result<(), inf_wast::Error> {
//! let wat = "(module (func))";
...
//! ```
//! use inf_wast::kw;
//! use inf_wast::core::{Import, Func};
//! use inf_wast::parser::{Parser, Parse, Result};
//!
...
impl<'a> Parser<'a> {
    ...
    /// ```
    /// # use inf_wast::kw;
    /// # use inf_wast::token::NameAnnotation;
    /// # use inf_wast::parser::*;
    /// struct Module<'a> {
    ...
    ///
    /// ```
    /// # use inf_wast::{kw, annotation};
    /// # use inf_wast::core::Custom;
    /// # use inf_wast::parser::*;
    /// struct Module<'a> {
    ///     fields: Vec<ModuleField<'a>>,
    /// }
